...
import { forwardRefWrapper, generateUUID } from "../../utils"
		...
		useEffect(() => {
			...
			if (inProp) {
				if (typeof window !== "undefined")
					document.documentElement.style.setProperty("--feedback-area-left", "0px")
			...
			<AnimatePresence initial mode="wait">
				{inProp ? (
					<EphemeralPortal>
						<FocusScope>
							<section
								className={classNames([styles.ModalSection, fluid && styles.fluid])}
								...
								<motion.div
									...
									<div
										...
										ref={ref}>
										{dismissible && (
											<div className={classNames([styles.ModalActionBar, title && styles.hasTitle])}>
												<button
...
const ModalFooter: React.FC<NativeElementProps<"div">> = ({ children, ...rest }) => {
	return (
